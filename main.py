...
classesFiles = '/home/danieletostiPI/ROBOT_FACE_11/coco.names'    # extract names from coco.names file
classNames = []
with open(classesFiles, 'rt') as f:
    classNames = f.read().rstrip('\n').split('\n')      # save all the class names in "classNames"

modelConfiguration = '/home/danieletostiPI/ROBOT_FACE_11/yolov3-320.cfg'
modelWeights = '/home/danieletostiPI/ROBOT_FACE_11/yolov3.weights'
